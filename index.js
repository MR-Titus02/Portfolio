...
const text = "Titus Senthilkumaran";  
        const speed = 150; // Typing speed
        const delayAfterTyping = 1500; // Delay before deleting
        const delayAfterDeleting = 500; // Delay before retyping
        ...
        function typeEffect() {
            if (!isDeleting && index < text.length) {
                hackerText.textContent = text.substring(0, index + 1);
                index++;
                ...
                setTimeout(typeEffect, isDeleting ? delayAfterTyping : delayAfterDeleting);
            }
        }
